...
**
** Created: Thu Dec 29 01:13:20 2011
...
static const char qt_meta_stringdata_MazeWidget[] = {
    "MazeWidget\0"
};

const QMetaObject MazeWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_MazeWidget,
      qt_meta_data_MazeWidget, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &MazeWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MazeWidget))
        return static_cast<void*>(const_cast< MazeWidget*>(this));
